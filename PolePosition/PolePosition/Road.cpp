	...
	*/
	...
	if (roadCurve.at(0) >= 0)
	{
		...
		for (int i = 0; i < middleLine.size(); i++)
		{
			...
			if (i == 0)
			{
				middleLine.at(i).setPoint(0, sf::Vector2f(width + height / 1.5,
					middleLine.at(i).getPoint(0).y));
				middleLine.at(i).setPoint(1, sf::Vector2f(width + middleLine.at(i).getPoint(1).y / 1.5 + 10,
			...
			//Setting D and C shapes (the bottom two points)
			middleLine.at(i).setPoint(3, sf::Vector2f(width + height / 1.5,
				middleLine.at(i).getPoint(3).y));
			middleLine.at(i).setPoint(2, sf::Vector2f(width + middleLine.at(i).getPoint(2).y / 1.5 + 10,
